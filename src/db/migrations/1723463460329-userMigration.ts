...
export class UserMigration1723463460329 implements MigrationInterface {
    name = 'UserMigration1723463460329'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "qr_code" ("qr_code_id" SERIAL NOT NULL, "qr_code_data" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL, "updated_at" TIMESTAMP NOT NULL, "userUserId" integer, "paymentPaymentId" integer, CONSTRAINT "PK_354d2deb45b7ac16c27d725af36" PRIMARY KEY ("qr_code_id"))`);
